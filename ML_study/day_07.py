...
#
# tf.app.flags.DEFINE_string("job_name", " ", "是否是参数服务器还是工作服务器")
# tf.app.flags.DEFINE_integer("task_index", 0, "指定第几台服务器")
#
#
# def main(argv):
#
...
#
#     # 1、创建集群对象
#     cluster = tf.train.ClusterSpec({"ps":["10.211.55.3:2222"], "worker": ["192.168.71.24:2223"]})
#
#     # 2、创建服务
...
#
#             sum = tf.matmul(var1, var2)
#
#             # 5、使用高级会话类
#             with tf.train.MonitoredTrainingSession(
#                 master="grpc://192.168.71.24:2223",
#                 is_chief=(FLAGS.task_index == 0),
#                 hooks=[tf.train.StopAtStepHook(last_step=200)],
#                 config=tf.ConfigProto(log_device_placement=True)
#             ) as mon_sess:
#                 while not mon_sess.should_stop():
#                     print(mon_sess.run(sum))
#
